...
namespace TaskFlow.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260426144826_TaskTemplates")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskTemplate", b =>
                {
                    ...
                    b.Property<int?>("DefaultDueDaysFromNow")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskTemplateChecklistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskTemplateChecklistItems");
                });

            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskTemplateTag", b =>
                {
                    b.Property<Guid>("TemplateId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TaskTemplateTags");
                });

            modelBuilder.Entity("TaskFlow.Domain.Entities.Webhook", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.WebhookDelivery", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.Task", b =>
                {
                    ...
                    b.HasOne("TaskFlow.Domain.Entities.TaskTemplate", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.TaskTemplateChecklistItem", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.TaskTemplate", "Template")
                        .WithMany("ChecklistItems")
                        .HasForeignKey("TemplateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TaskFlow.Domain.Entities.WebhookDelivery", b =>
                {
                    b.HasOne("TaskFlow.Domain.Entities.Webhook", "Webhook")
                        .WithMany("Deliveries")
